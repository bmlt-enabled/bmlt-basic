...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>All Closed Meetings In Brooklyn, NY Displayed As An Interactive Table</title>
        <?php $basic_bmlt_object->output_head('[[BMLT_TABLE(formats[]=4&meeting_key=location_city_subsection&meeting_key_value=Brooklyn)]]'); ?>
    </head>
    <body>
